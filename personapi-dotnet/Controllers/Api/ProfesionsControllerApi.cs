...
namespace personapi_dotnet.Controllers.Api
{
    ...
    [ApiController]
    public class ProfesionsControllerApi : ControllerBase
    {
        private readonly DBContext _context;

        public ProfesionsControllerApi(DBContext context)
        {
            _context = context;
        }

        // GET: api/ProfesionsControllerApi
        [HttpGet]
        ...
        // GET: api/ProfesionsControllerApi/5
        [HttpGet("{id}")]
        ...
        // PUT: api/ProfesionsControllerApi/5
        ...
        // POST: api/ProfesionsControllerApi
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/ProfesionsControllerApi/5
        [HttpDelete("{id}")]
