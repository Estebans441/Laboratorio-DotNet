...
namespace personapi_dotnet.Controllers.Api
{
    ...
    [ApiController]
    public class EstudiosControllerApi : ControllerBase
    {
        private readonly DBContext _context;

        public EstudiosControllerApi(DBContext context)
        {
            _context = context;
        }

        // GET: api/EstudiosControllerApi
        [HttpGet]
        ...
        // GET: api/EstudiosControllerApi/5
        [HttpGet("{id}")]
        ...
        // PUT: api/EstudiosControllerApi/5
        ...
        // POST: api/EstudiosControllerApi
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/EstudiosControllerApi/5
        [HttpDelete("{id}")]
