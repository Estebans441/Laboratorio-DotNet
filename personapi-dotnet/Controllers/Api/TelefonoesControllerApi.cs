...
namespace personapi_dotnet.Controllers.Api
{
    ...
    [ApiController]
    public class TelefonoesControllerApi : ControllerBase
    {
        private readonly DBContext _context;

        public TelefonoesControllerApi(DBContext context)
        {
            _context = context;
        }

        // GET: api/TelefonoesControllerApi
        [HttpGet]
        ...
        // GET: api/TelefonoesControllerApi/5
        [HttpGet("{id}")]
        ...
        // PUT: api/TelefonoesControllerApi/5
        ...
        // POST: api/TelefonoesControllerApi
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        ...
        // DELETE: api/TelefonoesControllerApi/5
        [HttpDelete("{id}")]
